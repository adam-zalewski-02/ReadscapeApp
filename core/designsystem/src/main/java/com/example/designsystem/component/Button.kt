...
fun ReadscapeOutlinedButton(
    ...
    OutlinedButton(
        ...
        border = BorderStroke(
            width = ReadscapeButtonDefaults.OutlinedButtonBorderWidth,
            color = if (enabled) {
                MaterialTheme.colorScheme.outline
            } else {
                MaterialTheme.colorScheme.onSurface.copy(
                    alpha = ReadscapeButtonDefaults.DisabledOutlinedButtonBorderAlpha,
                )
            },
        ),
        contentPadding = contentPadding,
 ...
 */
@Composable
private fun ReadscapeButtonContent(
    text: @Composable () -> Unit,
    leadingIcon: @Composable (() -> Unit)? = null,
) {
    if (leadingIcon != null) {
...
@ThemePreviews
@Composable
fun ReadscapeButtonPreview() {
    ReadscapeTheme {
        ReadscapeBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            ReadscapeButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun ReadscapeOutlinedButtonPreview() {
    ReadscapeTheme() {
        ReadscapeBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            ReadscapeOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun ReadscapeButtonLeadingIconPreview() {
    ReadscapeTheme {
        ReadscapeBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            ReadscapeButton(
                onClick = {},
                text = { Text("Test button") },
                leadingIcon = { Icon(imageVector = ReadscapeIcons.Add, contentDescription = null) },
            )
        }
    }
}
 ...
 */
object ReadscapeButtonDefaults {
    // TODO: File bug
